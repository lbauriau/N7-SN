...
for I= 1:N
    ...
    for J = 1:N
        ...
        pourcentage_tab(J,I) = pourcentage;
    end
end


% figure;
% surf(pourcentage_tab);
% title("Pourcentage de bonne classification en fonction de sigma et de lambda");